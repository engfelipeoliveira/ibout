...
public class ParameterServiceImpl implements ParameterService {
	...
	public List<String> validateParameters(Parameter parameter) {
		...
		if (parameter != null) {
			...
			if (!StringUtils.isBlank(parameter.getDataSource()) && !"TXT".equalsIgnoreCase(parameter.getDataSource())
					&& !"CSV".equalsIgnoreCase(parameter.getDataSource())
					&& !"BD".equalsIgnoreCase(parameter.getDataSource())
			...
			if (!StringUtils.isBlank(parameter.getDataSource()) && StringUtils.isBlank(parameter.getDirSource())
					&& ("TXT".equalsIgnoreCase(parameter.getDataSource())
							|| "CSV".equalsIgnoreCase(parameter.getDataSource())
							|| "XLS".equalsIgnoreCase(parameter.getDataSource()))) {
